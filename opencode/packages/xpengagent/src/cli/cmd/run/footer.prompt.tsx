...
import { normalizePromptContent } from "@xpengagent/tui/editor"
...
import { XPENGAGENT_BASE_MODE, useBindings } from "@xpengagent/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close XPENGagent" } satisfies SlashOption,
    ]
