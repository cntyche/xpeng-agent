...
import { Slug } from "@xpengagent/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@xpengagent/llm"
...
import { PartTable, SessionTable } from "@xpengagent/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@xpengagent/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".xpengagent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/Session") {}
