---
title: Compartilhar
description: Compartilhe suas conversas do xpengagent.
---

O recurso de compartilhamento do xpengagent permite que você crie links públicos para suas conversas do xpengagent, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o xpengagent:
...
O xpengagent suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o xpengagent usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `xpengagent.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o xpengagent em sua organização.
