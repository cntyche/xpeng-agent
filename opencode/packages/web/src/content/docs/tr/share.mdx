---
title: Paylasim
description: xpengagent konusmalarini genel baglantilarla paylasin.
---

xpengagent'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda xpengagent:
...
xpengagent, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak xpengagent manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `xpengagent.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda xpengagent kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
