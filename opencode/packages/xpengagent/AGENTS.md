...
- Running `bun dev` from `packages/xpengagent` starts the live interactive TUI. Do not run it as a blocking foreground command when you need to inspect the result.
