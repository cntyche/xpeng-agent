...
import { httpClient, path } from "@xpengagent/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/SkillDiscovery") {}
