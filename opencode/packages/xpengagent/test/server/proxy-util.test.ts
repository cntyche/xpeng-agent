...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips xpengagent-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-xpengagent-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-xpengagent-directory")).toBeNull()
      expect(result.get("x-xpengagent-workspace")).toBeNull()
