...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "xpengagent", key: "dialog.provider.xpengagent.note" },
  { match: (id: string) => id === "xpengagent-go", key: "dialog.provider.xpengagentGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "xpengagent" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "xpengagent" || item.id === "xpengagent-go" || item.id === "xpengagent-free"}>
