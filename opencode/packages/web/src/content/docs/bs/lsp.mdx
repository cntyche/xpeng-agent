---
title: LSP serveri
description: XPENGagent se integriše sa vašim LSP serverima.
---

XPENGagent se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

XPENGagent dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `XPENGAGENT_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i xpengagent otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj xpengagent konfiguraciji.
