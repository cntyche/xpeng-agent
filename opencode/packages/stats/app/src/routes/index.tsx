...
const statsHomeTitle = "AI Model Usage Rankings | XPENGagent Data"
const statsHomeDescription =
  "Explore XPENGagent Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns."
const statsHomeFallbackUrl = "https://xpengagent.cc.cd/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.xpengagent.cc.cd") return "https://xpengagent.cc.cd/data/"
  if (url.hostname === "stats.dev.xpengagent.cc.cd") return "https://dev.xpengagent.cc.cd/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across XPENGagent Go.</span>
      </h2>
      <Show
