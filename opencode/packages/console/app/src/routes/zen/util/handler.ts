...
import { and, Database, eq, isNull, lt, or, sql } from "@xpengagent/console-core/drizzle/index.js"
import { KeyTable } from "@xpengagent/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@xpengagent/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@xpengagent/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@xpengagent/console-core/util/date.js"
import { Identifier } from "@xpengagent/console-core/identifier.js"
import { Billing } from "@xpengagent/console-core/billing.js"
import { Actor } from "@xpengagent/console-core/actor.js"
import { WorkspaceTable } from "@xpengagent/console-core/schema/workspace.sql.js"
import { ZenData } from "@xpengagent/console-core/model.js"
import { Subscription } from "@xpengagent/console-core/subscription.js"
import { BlackData } from "@xpengagent/console-core/black.js"
import { UserTable } from "@xpengagent/console-core/schema/user.sql.js"
import { ModelTable } from "@xpengagent/console-core/schema/model.sql.js"
import { ProviderTable } from "@xpengagent/console-core/schema/provider.sql.js"
...
import { LiteData } from "@xpengagent/console-core/lite.js"
import { Resource } from "@xpengagent/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-xpengagent-session") ?? ""
    const requestId = input.request.headers.get("x-xpengagent-request") ?? ""
    const ocClient = input.request.headers.get("x-xpengagent-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-xpengagent-request")
          headers.delete("x-xpengagent-session")
          headers.delete("x-xpengagent-project")
          headers.delete("x-xpengagent-client")
          return headers
        })(),
        body: reqBody,
      })
    ...
    if (modelData.trialEnded)
      throw new ModelError(
        `${t("zen.api.error.trialEnded", {
          ...
          link: "https://xpengagent.cc.cd/go",
        })}`,
      )
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://xpengagent.cc.cd/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://xpengagent.cc.cd/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://xpengagent.cc.cd/workspace/${authInfo.workspaceID}/members`
