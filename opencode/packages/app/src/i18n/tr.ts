...
export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.xpengagent.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.xpengagentGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "XPENGagent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve XPENGagent'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve XPENGagent'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak XPENGagent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler xpengagent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi XPENGagent sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "XPENGagent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı XPENGagent ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (xpengagent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: XPENGagent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "XPENGagent Masaüstü",
  ...
  "settings.desktop.wsl.description": "XPENGagent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "XPENGagent'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "XPENGagent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "XPENGagent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "XPENGagent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "XPENGagent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "XPENGagent'un en son sürümünü kullanıyorsunuz.",
