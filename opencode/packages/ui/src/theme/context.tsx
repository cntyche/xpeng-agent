...
const STORAGE_KEYS = {
  THEME_ID: "xpengagent-theme-id",
  COLOR_SCHEME: "xpengagent-color-scheme",
  THEME_CSS_LIGHT: "xpengagent-theme-css-light",
  THEME_CSS_DARK: "xpengagent-theme-css-dark",
} as const
