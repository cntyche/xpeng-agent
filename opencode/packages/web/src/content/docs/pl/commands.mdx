...
Utwórz `.xpengagent/commands/test.md`:
...
Możesz zdefiniować polecenia w `xpengagent.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji xpengagent:
...
- Globalnie: `~/.config/xpengagent/commands/`
- Na projekt: `.xpengagent/commands/`
...
xpengagent zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
