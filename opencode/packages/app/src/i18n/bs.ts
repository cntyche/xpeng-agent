export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.xpengagent.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.xpengagentGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u XPENGagent-u.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Posjeti ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u XPENGagent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u XPENGagent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u xpengagent.json",
  ...
  "dialog.server.description": "Promijeni na koji se XPENGagent server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija XPENGagent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku XPENGagent timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (xpengagent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: XPENGagent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni XPENGagent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u XPENGagent-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako XPENGagent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li XPENGagent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu XPENGagent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se XPENGagent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju XPENGagent-a.",
