...
import type * as SDK from "@xpengagent/sdk/v2"
...
import { SessionShareTable } from "@xpengagent/core/share/sql"
...
const disabled = process.env["XPENGAGENT_DISABLE_SHARE"] === "true" || process.env["XPENGAGENT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/ShareNext") {}
