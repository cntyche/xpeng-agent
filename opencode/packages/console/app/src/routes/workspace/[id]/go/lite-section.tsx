...
import { Database, eq, and, isNull } from "@xpengagent/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@xpengagent/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#xpengagent-go")} target="_blank" rel="noopener noreferrer">
