...
const api: ElectronAPI = {
  ...
  wslServers: {
    ...
    probeXpengagent: (name) => ipcRenderer.invoke("wsl-servers-probe-xpengagent", name),
    installXpengagent: (name) => ipcRenderer.invoke("wsl-servers-install-xpengagent", name),
