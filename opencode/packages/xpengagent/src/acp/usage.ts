...
import type { AssistantMessage as XPENGagentAssistantMessage, Message } from "@xpengagent/sdk/v2"
...
export type AssistantTokenCost = Pick<XPENGagentAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<XPENGagentAssistantMessage, "role"> &
  Partial<Pick<XPENGagentAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@xpengagent/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@xpengagent/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@xpengagent/ACPUsage") {}
