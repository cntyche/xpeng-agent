export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.xpengagent.tagline": "Modelos optimizados y fiables",
  "dialog.provider.xpengagentGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.xpengagentZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.xpengagentZen.visit.prefix": "Visita ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en xpengagent.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de XPENGagent se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de XPENGagent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de XPENGagent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (xpengagent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, XPENGagent no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor XPENGagent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para XPENGagent",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve XPENGagent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si XPENGagent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de XPENGagent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia XPENGagent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de XPENGagent.",
