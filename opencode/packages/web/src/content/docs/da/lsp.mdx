---
title: LSP-servere
description: XPENGagent integreres med dine LSP-servere.
---

XPENGagent kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

XPENGagent leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `XPENGAGENT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og xpengagent åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din xpengagent-konfiguration.
