...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@xpengagent/llm"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/v2/ToolRegistry") {}
