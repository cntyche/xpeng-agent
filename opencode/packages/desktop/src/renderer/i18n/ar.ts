export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من XPENGagent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من XPENGagent، هل ترغب في تثبيته وإعادة تشغيله؟",
