export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.xpengagent.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.xpengagentGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Odwiedź ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w XPENGagent.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w xpengagent.json",
  ...
  "dialog.server.description": "Przełącz serwer XPENGagent, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja XPENGagent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu XPENGagent",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (xpengagent.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "XPENGagent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla XPENGagent",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd XPENGagent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy XPENGagent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw XPENGagent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania XPENGagent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji XPENGagent.",
