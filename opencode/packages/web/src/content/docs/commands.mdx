...
Create `.xpengagent/commands/test.md`:
...
You can add custom commands through the XPENGagent config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your XPENGagent [config](/docs/config):
...
- Per-project: `.xpengagent/commands/`
...
xpengagent includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
