...
Brug den til at bygge integrasjoner og kontrollere xpengagent programmatisk.
...
Opret en forekomst av xpengagent:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `xpengagent.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av xpengagent, kan du oprete en klientforekomst for at koble til den:
