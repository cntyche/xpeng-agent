---
title: Zen
description: xpengagent tarafından sağlanan seçilmiş modeller listesi.
---
...
XPENGagent Zen, XPENGagent ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, XPENGagent'daki diğer sağlayıcılar gibi çalışır. XPENGagent Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve XPENGagent kullanmak için buna ihtiyacınız yoktur.
...
:::tip
XPENGagent ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
XPENGagent Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

XPENGagent Zen, XPENGagent'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>XPENGagent Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, XPENGagent Zen'i seçin ve API anahtarınızı yapıştırın.
...
XPENGagent yapılandırmanızdaki [model id](/docs/config/#models) `xpengagent/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `xpengagent/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için XPENGagent'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için XPENGagent'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için XPENGagent'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için XPENGagent'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için XPENGagent'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
XPENGagent Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca XPENGagent ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
