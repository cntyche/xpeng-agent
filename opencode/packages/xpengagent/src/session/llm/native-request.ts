import type { JsonSchema, LLMRequest, ProviderMetadata } from "@xpengagent/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@xpengagent/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @xpengagent/llm request objects from xpengagent's session/AI SDK-shaped data.
  return LLM.request({
