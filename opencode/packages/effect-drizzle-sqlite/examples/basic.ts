...
class Database extends Context.Service<Database, DatabaseShape>()("@xpengagent/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@xpengagent/example/UserStore") {
