...
Ajan becerileri, xpengagent'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
xpengagent su konumlari tarar:

- Proje konfigurasyonu: `.xpengagent/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/xpengagent/skills/<name>/SKILL.md`
...
Proje yerel yollarinda xpengagent, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.xpengagent/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/xpengagent/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.xpengagent/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
xpengagent, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`xpengagent.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`xpengagent.json` icinde):
