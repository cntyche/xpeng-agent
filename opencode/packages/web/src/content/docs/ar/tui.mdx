---
title: TUI
description: استخدام واجهة المستخدم TUI في XPENGagent.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر XPENGagent واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل XPENGagent إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة XPENGagent في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى XPENGagent. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من XPENGagent. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `xpengagent.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار XPENGagent بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `xpengagent.default`.
