...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=xpengagent` lets xAI attribute xpengagent-originated
...
<html>
  <head>
    <title>XPENGagent - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>XPENGagent - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire xpengagent process. Matches the silent-
