...
import type { EffectDrizzleSqlite } from "@xpengagent/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/ProjectDirectories") {}
