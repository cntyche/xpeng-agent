...
export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.xpengagent.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.xpengagentGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Besøk ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i xpengagent.json",
  ...
  "dialog.server.description": "Bytt hvilken XPENGagent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av XPENGagent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til XPENGagent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (xpengagent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at XPENGagent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør XPENGagent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for XPENGagent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan XPENGagent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om XPENGagent skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan XPENGagent er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når XPENGagent starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av XPENGagent.",
