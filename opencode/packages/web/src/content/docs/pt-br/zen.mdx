---
title: Zen
description: Lista selecionada de modelos fornecidos pelo XPENGagent.
---
...
O XPENGagent Zen é uma lista de modelos testados e verificados fornecidos pela equipe do XPENGagent.

O Zen funciona como qualquer outro provedor no XPENGagent. Você faz login no XPENGagent Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o XPENGagent.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o XPENGagent.
:::
...
O XPENGagent Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O XPENGagent Zen funciona como qualquer outro provedor no XPENGagent.

1. Você faz login no **<a href={console}>XPENGagent Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona XPENGagent Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do XPENGagent usa o formato `xpengagent/<model-id>`. Por exemplo, para GPT 5.5, você usaria `xpengagent/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no XPENGagent por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no XPENGagent por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no XPENGagent por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no XPENGagent por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no XPENGagent por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o XPENGagent também.
