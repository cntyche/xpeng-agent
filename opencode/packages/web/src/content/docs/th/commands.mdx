...
สร้าง `.xpengagent/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ XPENGagent:
...
- ระดับผู้ใช้ (Global): `~/.config/xpengagent/commands/`
- ระดับโปรเจ็กต์: `.xpengagent/commands/`
...
XPENGagent มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
