...
//
// The saved variant persists across sessions in ~/.local/state/xpengagent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@xpengagent/RunVariant") {}
