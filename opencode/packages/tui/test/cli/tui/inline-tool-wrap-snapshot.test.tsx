...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/xpengagent/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/xpengagent (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/xpengagent/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/xpengagent/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const XPENGAGENT_DB|XPENGAGENT_DB|XPENGAGENT_DEV|Global\\.Path\\.data|data =" in packages/xpengagent/src (115 matches)',
  },
] as const
