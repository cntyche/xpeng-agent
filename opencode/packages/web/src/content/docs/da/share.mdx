---
title: Deling
description: Del dine XPENGagent-samtaler.
---

XPENGagents delingsfunksjon lar deg lage offentlige lenker til dine XPENGagent-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, XPENGagent:
...
XPENGagent støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger XPENGagent manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `xpengagent.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av xpengagent i organisasjonen din.
