...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips xpengagent-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-xpengagent-directory"]).toBeUndefined()
      expect(forwarded["x-xpengagent-workspace"]).toBeUndefined()
