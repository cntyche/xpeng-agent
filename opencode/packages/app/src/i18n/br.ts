export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.xpengagent.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.xpengagentGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Visite ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em xpengagent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor XPENGagent este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do XPENGagent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do XPENGagent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (xpengagent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: XPENGagent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor XPENGagent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do XPENGagent",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o XPENGagent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o XPENGagent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o XPENGagent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o XPENGagent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do XPENGagent.",
