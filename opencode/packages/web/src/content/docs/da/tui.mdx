---
title: TUI
description: Brug af XPENGagent-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

XPENGagent giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre XPENGagent starter TUI for den nuværende mappe.
...
Når du bruger XPENGagent TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til XPENGagent. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut XPENGagent. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `xpengagent.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe XPENGagent venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `xpengagent.default`.
