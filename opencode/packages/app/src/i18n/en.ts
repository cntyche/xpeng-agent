export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.xpengagent.tagline": "Reliable optimized models",
  "dialog.provider.xpengagentGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in XPENGagent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.xpengagentZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.xpengagentZen.visit.prefix": "Visit ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins configured in xpengagent.json",
  ...
  "dialog.server.description": "Switch which XPENGagent server this app connects to.",
  ...
  "wsl.onboarding.step.xpengagent": "XPENGagent",
  ...
  "wsl.onboarding.checkingOpencode": "Checking XPENGagent...",
  "wsl.onboarding.checkingOpencodeIn": "Checking XPENGagent in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating XPENGagent...",
  "wsl.onboarding.updatingOpencodeIn": "Updating XPENGagent in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update XPENGagent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update XPENGagent",
  "wsl.onboarding.xpengagentReadyIn": "XPENGagent is ready in {{distro}}.",
  "wsl.onboarding.xpengagentReady": "XPENGagent is ready.",
  "wsl.onboarding.installXpengagentIn": "Install XPENGagent in {{distro}}.",
  "wsl.onboarding.installXpengagent": "Install XPENGagent",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen XPENGagent.",
  ...
  "toast.update.description": "A new version of XPENGagent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the XPENGagent team",
  ...
  "error.chain.checkConfig": "Check your config (xpengagent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, XPENGagent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent includes free models so you can start immediately.",
  ...
  "app.name.desktop": "XPENGagent Desktop",
  ...
  "settings.desktop.wsl.description": "Run the XPENGagent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for XPENGagent",
  ...
  "settings.general.row.appearance.description": "Customise how XPENGagent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether XPENGagent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how XPENGagent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when XPENGagent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of XPENGagent.",
