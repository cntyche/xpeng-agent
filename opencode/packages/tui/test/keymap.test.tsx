...
import { getOpencodeModeStack, XPENGAGENT_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when xpengagent mode changes", async () => {
