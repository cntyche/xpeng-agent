...
Kreiraj `.xpengagent/commands/test.md`:
...
Možete dodati prilagođene komande kroz XPENGagent konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom XPENGagent [config](/docs/config):
...
- Globalno: `~/.config/xpengagent/commands/`
- Po projektu: `.xpengagent/commands/`
...
XPENGagent uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
