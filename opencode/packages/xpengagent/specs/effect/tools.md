...
Practical reference for the current tool-migration state in `packages/xpengagent`.
...
Tool tests should use the existing Effect helpers in `packages/xpengagent/test/lib/effect.ts`:
