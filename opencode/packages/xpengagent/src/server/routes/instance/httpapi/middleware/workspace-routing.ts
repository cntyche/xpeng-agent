...
>()("@xpengagent/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@xpengagent/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.XPENGAGENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.XPENGAGENT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-xpengagent-directory"] || process.cwd()
}
