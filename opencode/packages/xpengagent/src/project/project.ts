...
import { ProjectDirectoryTable, ProjectTable } from "@xpengagent/core/project/sql"
...
import { which } from "@xpengagent/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@xpengagent/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.XPENGAGENT_FAKE_VCS)
