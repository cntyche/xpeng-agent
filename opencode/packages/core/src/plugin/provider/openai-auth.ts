...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `xpengagent/${InstallationVersion}` }
}
...
const successPage =
  "<!doctype html><title>XPENGagent</title><h1>Authorization successful</h1><p>You can close this window.</p>"
const errorPage = (message: string) =>
  `<!doctype html><title>XPENGagent</title><h1>Authorization failed</h1><p>${message.replace(/[&<>"']/g, "")}</p>`
