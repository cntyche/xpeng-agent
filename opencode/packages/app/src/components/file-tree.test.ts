...
beforeAll(async () => {
  ...
  mock.module("@xpengagent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@xpengagent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@xpengagent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@xpengagent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
