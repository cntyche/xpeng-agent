...
import { EventSequenceTable, EventTable } from "@xpengagent/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/Workspace") {}
