...
import compareVideo from "../../asset/lander/xpengagent-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/xpengagent-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="xpengagent:auth" content={loggedin() ? "true" : "false"} />
