...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      XPENGAGENT_EXPERIMENTAL_WORKSPACES: Flag.XPENGAGENT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.XPENGAGENT_EXPERIMENTAL_WORKSPACES = original.XPENGAGENT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
