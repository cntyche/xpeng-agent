...
<html>
  <head>
    <title>XPENGagent - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>XPENGagent - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "xpengagent"
      output.headers["User-Agent"] = `xpengagent/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
