...
const appId = channel === "prod" ? "ai.xpengagent.desktop" : `ai.xpengagent.desktop.${channel}`
const productName = channel === "prod" ? "XPENGagent" : `XPENGagent ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      XPENGagent is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
