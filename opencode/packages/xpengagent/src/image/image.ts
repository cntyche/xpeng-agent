...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __XPENGAGENT_PHOTON_WASM_PATH?: string }).__XPENGAGENT_PHOTON_WASM_PATH =
