...
declare const XPENGAGENT_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof XPENGAGENT_CLI_NAME === "string" ? XPENGAGENT_CLI_NAME : "xpengagent", {
  description: "XPENGagent 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
