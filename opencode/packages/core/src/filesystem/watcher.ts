...
declare const XPENGAGENT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof XPENGAGENT_LIBC === "undefined" ? undefined : XPENGAGENT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.XPENGAGENT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.XPENGAGENT_EXPERIMENTAL_FILEWATCHER) {
