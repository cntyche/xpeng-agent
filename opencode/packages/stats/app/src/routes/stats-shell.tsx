import xpengagentWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/xpengagent",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star XPENGagent on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "xpengagent:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://xpengagent.cc.cd/">
            <strong>Try XPENGagent</strong>
          </a>
          <button
...
function XPENGagentMark() {
  return (
    <svg data-slot="xpengagent-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://xpengagent.cc.cd/legal/terms-of-service", label: "Terms of service" },
    { href: "https://xpengagent.cc.cd/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@xpengagent.cc.cd", label: "Contact us" },
    { href: "https://xpengagent.cc.cd/discord", label: "Community" },
    { href: "https://x.com/xpengagent", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://xpengagent.cc.cd" aria-label="XPENGagent home">
          <XPENGagentMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={xpengagentWordmarkDark} alt="XPENGagent" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">XPENGagent Newsletter</h2>
            <p>
