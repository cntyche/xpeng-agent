...
import { path } from "@xpengagent/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@xpengagent/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `xpengagent/${name}`
