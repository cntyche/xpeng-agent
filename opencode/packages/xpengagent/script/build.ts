...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    files: embeddedFileMap ? { "xpengagent-web-ui.gen.ts": embeddedFileMap } : {},
    entrypoints: ["./src/index.ts", parserWorker, workerPath, ...(embeddedFileMap ? ["xpengagent-web-ui.gen.ts"] : [])],
    define: {
