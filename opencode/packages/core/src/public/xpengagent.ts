export * as XpengAgent from "./xpengagent"
...
/** Intentional public native API for Effect applications embedding XPENGagent. */
export class Service extends Context.Service<Service, Interface>()("@xpengagent/public/XPENGagent") {}
...
>()("@xpengagent/public/XPENGagent/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("XPENGagent.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("XPENGagent.sessions.switchModel")(function* (input) {
...
// TODO: Add XPENGagent.create(...) as the Promise facade over the same native API semantics.
