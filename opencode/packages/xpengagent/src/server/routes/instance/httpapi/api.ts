...
export const RootHttpApi = HttpApi.make("xpengagent-root")
...
export const InstanceHttpApi = HttpApi.make("xpengagent-instance")
...
export const XPENGagentHttpApi = HttpApi.make("xpengagent")
