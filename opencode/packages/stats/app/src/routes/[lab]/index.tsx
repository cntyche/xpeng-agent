...
export default function StatsLab() {
  ...
  const labTitle = createMemo(() => `${labName()} AI Model Usage & Rankings | XPENGagent Data`)
  const labDescription = createMemo(
    () =>
      `Compare ${labName()} models used in XPENGagent Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.`,
  )
    ...
    <section id="overview" data-section="lab-hero">
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <h1>Model Lab</h1>
          <p>Reading model availability and recent XPENGagent usage.</p>
        </div>
      </div>
    </section>
  )
    ...
    <section id="overview" data-section="lab-hero">
      ...
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <p>
            Explore {props.lab.models.length} {props.lab.name} models used in XPENGagent
        ...
        <div data-component="model-rank-panel">
          ...
          <p>
            {props.stats
              ? `${formatPercent(props.stats.tokenShare)} of recent XPENGagent usage`
              : latest()
  ...
  return (
    <section id="usage" data-section="model-panel">
      <p data-slot="section-title">
        ...
        <span>Daily XPENGagent token volume over the last two months.</span>
      </p>
      <Show
