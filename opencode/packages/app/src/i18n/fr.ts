export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.xpengagent.tagline": "Modèles optimisés et fiables",
  "dialog.provider.xpengagentGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Visitez ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans xpengagent.json",
  ...
  "dialog.server.description": "Changez le serveur XPENGagent auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'XPENGagent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe XPENGagent",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (xpengagent.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'XPENGagent ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "XPENGagent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur XPENGagent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour XPENGagent",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'XPENGagent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si XPENGagent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'XPENGagent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'XPENGagent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'XPENGagent.",
