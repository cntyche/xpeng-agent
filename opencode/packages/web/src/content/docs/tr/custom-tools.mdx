---
title: Özel Araçlar
description: LLM'un xpengagent'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. xpengagent'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.xpengagent/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/xpengagent/tools/` içine yerleştirerek.
