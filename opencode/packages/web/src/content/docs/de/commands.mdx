...
Erstellen Sie `.xpengagent/commands/test.md`:

```md title=".xpengagent/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die XPENGagent-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem XPENGagent [config](/docs/config):

```json title="xpengagent.jsonc" {4-12}
{
...
- Global: `~/.config/xpengagent/commands/`
- Pro Projekt: `.xpengagent/commands/`

```markdown title="~/.config/xpengagent/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".xpengagent/commands/component.md"
---
...
```md title=".xpengagent/commands/create-file.md"
---
...
```md title=".xpengagent/commands/analyze-coverage.md"
---
...
```md title=".xpengagent/commands/review-changes.md"
---
...
```md title=".xpengagent/commands/review-component.md"
---
...
XPENGagent enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
