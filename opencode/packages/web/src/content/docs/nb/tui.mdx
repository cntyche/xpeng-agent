---
title: TUI
description: Bruke xpengagent-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

XPENGagent gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre XPENGagent starter TUI for gjeldende katalog.
...
Når du bruker XPENGagent TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til XPENGagent. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt XPENGagent. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `xpengagent.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge XPENGagent venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `xpengagent.default`.
