 ...
 *   "@xpengagent/ServerAuthConfig",
 *   {
 *     password: Config.string("XPENGAGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("XPENGAGENT_SERVER_USERNAME").pipe(Config.withDefault("xpengagent")),
 *   },
 * ) {}
 *
