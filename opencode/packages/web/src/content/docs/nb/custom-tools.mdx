...
description: Lag verktøy som LLM kan kalle inn XPENGagent.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med XPENGagent sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.xpengagent/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/xpengagent/tools/`.
