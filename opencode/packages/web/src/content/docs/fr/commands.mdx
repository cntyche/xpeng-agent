...
Créez `.xpengagent/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration XPENGagent ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre XPENGagent [config](/docs/config) :
...
- Par projet : `.xpengagent/commands/`
...
xpengagent comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
