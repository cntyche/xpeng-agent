import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@xpengagent/sdk/v2"
import { SessionTurn } from "@xpengagent/ui/session-turn"
import { SessionReview } from "@xpengagent/ui/session-review"
import { DataProvider } from "@xpengagent/ui/context"
import { FileComponentProvider } from "@xpengagent/ui/context/file"
import { WorkerPoolProvider } from "@xpengagent/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@xpengagent/ui/logo"
import { IconButton } from "@xpengagent/ui/icon-button"
import { ProviderIcon } from "@xpengagent/ui/provider-icon"
import { iife } from "@xpengagent/core/util/iife"
import { Binary } from "@xpengagent/core/util/binary"
import { NamedError } from "@xpengagent/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@xpengagent/ui/tabs"
import { MessageNav } from "@xpengagent/ui/message-nav"
import { FileSSR } from "@xpengagent/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@xpengagent/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/xpengagent-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | XPENGagent</Title>
              </Show>
              <Meta name="description" content="xpengagent - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/xpengagent"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://xpengagent.cc.cd/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
