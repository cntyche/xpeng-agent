...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/xpengagent.git")).toEqual({ owner: "sst", repo: "xpengagent" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/xpengagent")).toEqual({ owner: "sst", repo: "xpengagent" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/xpengagent.git")).toEqual({ owner: "sst", repo: "xpengagent" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/xpengagent")).toEqual({ owner: "sst", repo: "xpengagent" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/xpengagent.git")).toEqual({ owner: "sst", repo: "xpengagent" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/xpengagent")).toEqual({ owner: "sst", repo: "xpengagent" })
})
