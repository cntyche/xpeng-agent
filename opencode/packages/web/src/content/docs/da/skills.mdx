...
Agentferdigheter lar XPENGagent oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
XPENGagent søker etter disse stedene:

- Prosjektkonfigurasjon: `.xpengagent/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/xpengagent/skills/<name>/SKILL.md`
...
For prosjektlokale stier går XPENGagent opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.xpengagent/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/xpengagent/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.xpengagent/skills/git-release/SKILL.md` slik:
...
XPENGagent viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `xpengagent.json`:
...
**For innebygde agenter** (i `xpengagent.json`):
