...
Con XPENGagent puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, XPENGagent usa nuestro propio tema `xpengagent`.
...
XPENGagent viene con varios temas integrados.
...
- Quiere que XPENGagent coincida con la apariencia de su terminal
...
XPENGagent admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/xpengagent/themes/*.json` o `$XDG_CONFIG_HOME/xpengagent/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.xpengagent/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.xpengagent/themes/*.json`
