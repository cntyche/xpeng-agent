...
export const TypeId: TypeId = "~@xpengagent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@xpengagent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@xpengagent/effect-sqlite-node/NodeSqliteClient")
