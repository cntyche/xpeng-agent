...
import { AccountStateTable, AccountTable } from "@xpengagent/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@xpengagent/AccountRepo") {}
