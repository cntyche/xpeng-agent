...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "XPENGagent Documentation", href: "https://xpengagent.cc.cd/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/xpengagent" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anomalyco/xpengagent/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/xpengagent/issues/new?template=bug_report.yml",
      },
    ],
  },
]
