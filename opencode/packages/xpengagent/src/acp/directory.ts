...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@xpengagent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@xpengagent/ACPDirectory") {}
