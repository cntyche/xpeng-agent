# Remove `packages/xpengagent/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/xpengagent/src/storage/db.ts` module.
...
Production imports from `packages/xpengagent/src/storage/db.ts` are concentrated in 22 source files:

- `packages/xpengagent/src/account/repo.ts`
- `packages/xpengagent/src/cli/cmd/db.ts`
- `packages/xpengagent/src/cli/cmd/import.ts`
- `packages/xpengagent/src/cli/cmd/stats.ts`
- `packages/xpengagent/src/control-plane/workspace.ts`
- `packages/xpengagent/src/index.ts`
- `packages/xpengagent/src/node.ts`
- `packages/xpengagent/src/permission/index.ts`
- `packages/xpengagent/src/project/project.ts`
- `packages/xpengagent/src/server/projectors.ts`
- `packages/xpengagent/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/xpengagent/src/server/shared/fence.ts`
- `packages/xpengagent/src/session/message-v2.ts`
- `packages/xpengagent/src/session/projectors.ts`
- `packages/xpengagent/src/session/prompt.ts`
- `packages/xpengagent/src/session/session.ts`
- `packages/xpengagent/src/session/todo.ts`
- `packages/xpengagent/src/share/share-next.ts`
- `packages/xpengagent/src/storage/db.ts`
- `packages/xpengagent/src/sync/index.ts`
- `packages/xpengagent/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/xpengagent/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/xpengagent/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/xpengagent`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/xpengagent/src`
- `bun typecheck` from `packages/xpengagent`
- Relevant package tests from `packages/xpengagent`, not the repo root
