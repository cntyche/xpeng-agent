...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@xpengagent/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@xpengagent/llm/route"
import { OpenAI } from "@xpengagent/llm/providers"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-xpengagent-tutorial": "1" },
    query: { debug: "1" },
  },
})
