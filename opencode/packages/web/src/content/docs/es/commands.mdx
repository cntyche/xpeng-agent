...
Crear `.xpengagent/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración XPENGagent o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su XPENGagent [config](/docs/config):
...
- Por proyecto: `.xpengagent/commands/`
...
xpengagent incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
