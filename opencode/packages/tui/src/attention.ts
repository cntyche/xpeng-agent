...
import defaultSoundPath from "@xpengagent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@xpengagent/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@xpengagent/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@xpengagent/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@xpengagent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@xpengagent/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "xpengagent"
const DEFAULT_PACK_ID = "xpengagent.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "XPENGagent Default",
  builtin: true,
  sounds: {
