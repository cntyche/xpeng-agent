---
title: Zen
description: Liste organisée de modèles fournis par XPENGagent.
---
...
XPENGagent Zen est une liste de modèles testés et vérifiés fournie par l'équipe XPENGagent.

Zen fonctionne comme n'importe quel autre fournisseur dans XPENGagent. Vous vous connectez à XPENGagent Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser XPENGagent.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec XPENGagent.
:::
...
XPENGagent Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

XPENGagent Zen fonctionne comme n'importe quel autre fournisseur dans XPENGagent.

1. Vous vous connectez à **<a href={console}>XPENGagent Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez XPENGagent Zen et collez votre clé API.
...
| ---------------------- | ---------------------- | ---------------------------------------------------- | --------------------------- |
| GPT 5.5                | gpt-5.5                | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.5 Pro            | gpt-5.5-pro            | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4                | gpt-5.4                | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Pro            | gpt-5.4-pro            | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark    | gpt-5.3-codex-spark    | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2                | gpt-5.2                | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max      | gpt-5.1-codex-max      | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini     | gpt-5.1-codex-mini     | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5                  | gpt-5                  | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Codex            | gpt-5-codex            | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://xpengagent.cc.cd/zen/v1/responses`               | `@ai-sdk/openai`            |
| Claude Fable 5         | claude-fable-5         | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.8        | claude-opus-4-8        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.7        | claude-opus-4-7        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.6        | claude-opus-4-6        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.5        | claude-opus-4-5        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.1        | claude-opus-4-1        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6      | claude-sonnet-4-6      | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5      | claude-sonnet-4-5      | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4        | claude-sonnet-4        | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Gemini 3.5 Flash       | gemini-3.5-flash       | `https://xpengagent.cc.cd/zen/v1/models/gemini-3.5-flash` | `@ai-sdk/google`            |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://xpengagent.cc.cd/zen/v1/models/gemini-3.1-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://xpengagent.cc.cd/zen/v1/models/gemini-3-flash`   | `@ai-sdk/google`            |
| Qwen3.7 Max            | qwen3.7-max            | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus           | qwen3.7-plus           | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://xpengagent.cc.cd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| DeepSeek V4 Pro        | deepseek-v4-pro        | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash      | deepseek-v4-flash      | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.7           | minimax-m2.7           | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5.1                | glm-5.1                | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5                  | glm-5                  | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.5              | kimi-k2.5              | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.6              | kimi-k2.6              | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Grok Build 0.1         | grok-build-0.1         | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Big Pickle             | big-pickle             | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiMo-V2.5 Free         | mimo-v2.5-free         | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| North Mini Code Free   | north-mini-code-free   | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Nemotron 3 Ultra Free  | nemotron-3-ultra-free  | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Free | deepseek-v4-flash-free | `https://xpengagent.cc.cd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration XPENGagent utilise le format `xpengagent/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `xpengagent/gpt-5.5` dans votre configuration.
...
```
https://xpengagent.cc.cd/zen/v1/models
```
...
- DeepSeek V4 Flash Free est disponible sur XPENGagent pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur XPENGagent pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur XPENGagent pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur XPENGagent pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur XPENGagent pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé XPENGagent Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec XPENGagent également.
