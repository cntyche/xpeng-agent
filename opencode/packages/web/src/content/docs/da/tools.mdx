...
Her er alle de innebygde verktøyene som er tilgængelige i XPENGagent.
...
:::note
Dette verktøyet er bare tilgængelig når `XPENGAGENT_EXPERIMENTAL_LSP_TOOL=true` (eller `XPENGAGENT_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger XPENGagent-leverandøren eller når miljøvariabelen `XPENGAGENT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
