...
Opprett `.xpengagent/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom XPENGagent-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i XPENGagent [config](/docs/config):
...
- Per prosjekt: `.xpengagent/commands/`
...
XPENGagent inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
