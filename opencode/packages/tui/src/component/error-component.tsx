...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/anomalyco/xpengagent/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("xpengagent-version", InstallationVersion)
