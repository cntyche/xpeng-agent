...
`.xpengagent/commands/test.md` oluştur:
...
xpengagent işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

xpengagent [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/xpengagent/commands/`
- Proje başına: `.xpengagent/commands/`
...
xpengagent, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
