---
title: SDK
description: xpengagent sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

xpengagent JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
xpengagent'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir xpengagent örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `xpengagent.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir xpengagent örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
