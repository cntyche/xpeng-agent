...
import { ProviderPlugins } from "@xpengagent/core/plugin/provider"
import { ZenmuxPlugin } from "@xpengagent/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://xpengagent.cc.cd/", "X-Title": "xpengagent" })
