export const dict = {
  ...
  "dialog.provider.xpengagent.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.xpengagent.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.xpengagentGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af XPENGagent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i XPENGagent.",
  ...
  "provider.connect.xpengagentZen.line1":
    "XPENGagent Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.xpengagentZen.visit.prefix": "Besøg ",
  "provider.connect.xpengagentZen.visit.link": "xpengagent.cc.cd/zen",
  "provider.connect.xpengagentZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i XPENGagent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i XPENGagent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i xpengagent.json",
  ...
  "dialog.server.description": "Skift hvilken XPENGagent-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af XPENGagent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til XPENGagent-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (xpengagent.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, XPENGagent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "XPENGagent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør XPENGagent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for XPENGagent",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan XPENGagent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om XPENGagent følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan XPENGagent er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når XPENGagent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af XPENGagent.",
