...
Crea `.xpengagent/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di XPENGagent o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di XPENGagent:
...
- Globale: `~/.config/xpengagent/commands/`
- Per progetto: `.xpengagent/commands/`
...
xpengagent include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
