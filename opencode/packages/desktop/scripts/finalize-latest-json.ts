...
const releaseId = process.env.XPENGAGENT_RELEASE
if (!releaseId) throw new Error("XPENGAGENT_RELEASE is required")

const version = process.env.XPENGAGENT_VERSION
if (!version) throw new Error("XPENGAGENT_VERSION is required")
...
const macxTarGz = "xpengagent-desktop-mac-x64.app.tar.gz"
const macaTarGz = "xpengagent-desktop-mac-arm64.app.tar.gz"
