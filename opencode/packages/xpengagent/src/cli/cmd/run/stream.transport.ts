...
import type { Event, GlobalEvent, OpencodeClient } from "@xpengagent/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@xpengagent/RunStreamTransport") {}
