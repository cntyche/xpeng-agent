...
import { Tooltip, TooltipKeybind } from "@xpengagent/ui/tooltip"
import { useTheme } from "@xpengagent/ui/theme/context"
import { IconButtonV2 } from "@xpengagent/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@xpengagent/ui/v2/icon"
import { KeybindV2 } from "@xpengagent/ui/v2/keybind-v2"
import { TooltipV2 } from "@xpengagent/ui/v2/tooltip-v2"
...
import { base64Encode } from "@xpengagent/core/util/encode"
import { ProjectAvatar } from "@xpengagent/ui/v2/project-avatar-v2"
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="xpengagent-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="xpengagent-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="xpengagent-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_XPENGAGENT_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_XPENGAGENT_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
