import type { WslDistroProbe, WslXpengagentCheck, WslServerItem } from "../../preload/types"
...
export function clearWslDistroState(
  ...
  const nextOpencodeChecks = { ...xpengagentChecks }
  delete nextDistroProbes[distro]
  delete nextOpencodeChecks[distro]
  return { distroProbes: nextDistroProbes, xpengagentChecks: nextOpencodeChecks }
}
