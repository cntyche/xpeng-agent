---
title: Teilen
description: Teile XPENGagent-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu XPENGagent-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht XPENGagent Folgendes:
...
XPENGagent hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt XPENGagent den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`xpengagent.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du xpengagent in deiner Organisation einsetzt.
