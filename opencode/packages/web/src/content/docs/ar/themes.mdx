...
مع XPENGagent يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم XPENGagent سمتنا `xpengagent`.
...
يأتي XPENGagent مع عدة سمات مدمجة.
...
- يريدون أن يطابق XPENGagent مظهر terminal لديهم
...
يدعم XPENGagent نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/xpengagent/themes/*.json` أو `$XDG_CONFIG_HOME/xpengagent/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.xpengagent/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.xpengagent/themes/*.json`
