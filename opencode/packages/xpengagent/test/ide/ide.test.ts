...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders XPENGAGENT_CALLER", () => {
    process.env["XPENGAGENT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode XPENGAGENT_CALLER", () => {
    process.env["XPENGAGENT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown XPENGAGENT_CALLER", () => {
    process.env["XPENGAGENT_CALLER"] = "unknown"
