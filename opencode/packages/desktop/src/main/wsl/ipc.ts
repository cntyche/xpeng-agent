...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-xpengagent", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeXpengagent(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-xpengagent", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installXpengagent(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-xpengagent", unavailable)
  ipcMain.handle("wsl-servers-install-xpengagent", unavailable)
